<style type="text/css">
	...
	.sx_hs_comments div,.sx_hs_comments td,.sx_hs_comments th,.sx_hs_comments textarea,.sx_hs_comments input,.sx_hc_comments_box{
		font-family: "微软雅黑";font-size:14px;a
	}
	...
	.sx_hs_comments .sx_comments_submit a{width:102px; height:30px; background:url(<?php echo base_url();?>assets/images/template/post-btn-chengse.jpg) no-repeat; display:inline-block;}
	.sx_hs_comments .sx_comments_submit a:hover{width:102px; height:30px; background:url(<?php echo base_url();?>assets/images/template/post-btn-chengse2.jpg) no-repeat; display:inline-block;}
	
	.sx_hs_box{width:100%; float:left; height:auto; padding-bottom:12px;}
	.sx_hs_forms{width:100%; float:left; height:40px;}
	.sx_hs_forms_login{width:40px; height:40px; border-radius:50%; text-align:center;border:#fba222 1px solid;font-size:16px; line-height:40px;color:#fba222; margin-left:12px; position:absolute;z-index:4; margin-top:3px; background:#FFF; cursor:pointer;}
	.sx_hs_forms_login_avatar{width:40px; height:40px; text-align:center;font-size:16px;color:#fba222; margin-left:12px; position:absolute;z-index:4; margin-top:3px; background:#FFF;cursor:pointer; display:none;border-radius:50%;}
	...
	.sx_hs_comments .sx_inputcomments{width:100%;float:left;height:auto;border:#fba222 1px solid;border-radius:8px; padding-top:18px; position:relative;z-index:1;background:#FFF;}
	
	.sx_hs_forms_face{width:30px; float:left; height:30px; padding-top:18px; padding-left:15px;}
	.sx_hs_forms_face a{width:18px;height:18px; background:url(<?php echo base_url();?>assets/images/template/face_orange.jpg) no-repeat; display:inline-block;}
	.sx_hs_forms_face a:hover{width:18px;height:18px; background:url(<?php echo base_url();?>assets/images/template/face_orange2.jpg) no-repeat; display:inline-block;}
	...
	.sx_hs_comments_lists .sx_item_title{position:absolute;z-index:2;width: 70px; line-height: 30px; border:#fba222 1px solid;border-top-right-radius: 8px; background: #fff; border-bottom: none;border-top-left-radius: 8px; text-align: center;color:#fba222;font-size:16px;}
	.sx_hs_comments_lists .sx_item_line{line-height: 30px;height: 30px;position: relative;overflow: hidden;border-bottom:#fba222 1px solid; text-align: right;color:#fba222;}
	.sx_hs_comments_start{width: 100%; float: left; height:auto; padding-top:20px;}
	.sx_hs_comments_start .sx_comments_alts{width:100px; float: left;padding-left:15px; text-align: left; line-height:55px;font-size:16px;font-weight:blod;color:#fba222;}
	...
	.sx_hs_comments_nickname{width:110px; float: left; height: 30px; line-height: 30px;color:#fba222;font-size:12px; overflow:hidden;}
	.sx_hs_comments_nickname a{color:#fba222;font-size:12px;text-decoration:none;}
	.sx_hs_comments_nickname a:hover{color:#fba222;font-size:12px;text-decoration:none;}
	...
	.sx_hs_forms_login_down{width:45px;height:40px; border-radius:50%; background:#FFF; position:absolute;z-index:2;border:#fba222 1px solid; margin-left:10px; margin-top:10px;}
	.sx_hs_forms_login_down_bg{width:70px;height:40px; background:#fff; position:absolute;z-index:3;margin-left:10px;}
	.sx_hs_forms_login_nickname{width:auto; height:40px; line-height:40px; text-align:center; background:#FFF; position:absolute;z-index:5; margin-left:70px; margin-top:20px; padding-left:10px; padding-right:10px;color:#fba222; display:none;}
	...
	#hs_forms_face_position{width:306px; height:auto; position:absolute;z-index:4; border:#fba222 1px solid; background:#FFF;padding-left:9px;padding-bottom:9px; border-radius:10px; margin-top:30px; display:none;}
	...
	.sx_hs_forms_face_re_position{width:306px; height:auto; position:absolute;z-index:4; border:#fba222 1px solid; background:#FFF;padding-left:9px;padding-bottom:9px; border-radius:10px; margin-top:30px; display:none; margin-left:10px; padding-top:12px; padding-bottom:12px;}
	...
	.sx_re_comments_textarea textarea{width:100%; height:110px; outline:none; border:#fba222 1px solid; border-radius:12px; padding:8px 8px 8px 8px;color:#ccc;background:url(<?php echo base_url();?>assets/images/input_bg.png) center center no-repeat;resize:none;}
	.sx_re_comments_subs{width:100%; height:auto; float:left;}
	.sx_re_face_inner{width:40px; float:left; height:auto; padding-left:10px;}
	.sx_re_face_inner a{width:18px;height:18px;background: url(<?php echo base_url();?>assets/images/template/face_orange.jpg) no-repeat;display: inline-block;}
	.sx_re_face_inner a:hover{width:18px;height:18px;background: url(<?php echo base_url();?>assets/images/template/face_orange2.jpg) no-repeat;display: inline-block;}
	.sx_re_face_comments_btn{width:200px; float:right; height:auto; text-align:right;}
	.sx_re_face_comments_btn a{width: 102px;height: 30px;background: url(<?php echo base_url();?>assets/images/template/post-btn-chengse.jpg) no-repeat;display: inline-block;}
	.sx_re_face_comments_btn a:hover{width: 102px;height: 30px;background: url(<?php echo base_url();?>assets/images/template/post-btn-chengse2.jpg) no-repeat;display: inline-block;}
	...
	.sx_hc_comments_re_item .sx_members_infos .sx_nickname{width:100px; float:left; height:30px; line-height:30px;font-size:12px;color:#fba222;}
	.sx_hc_comments_re_item .sx_members_infos .sx_nickname a{color:#fba222;text-decoration:none;}
	.sx_hc_comments_re_item .sx_members_infos .sx_nickname a:hover{color:#fba222;text-decoration:underline;}
	...
	.sx_comments_re_button .sx_cai a:hover{background:url(<?php echo base_url();?>assets/images/cai-active.png) 0px 4px no-repeat;color:#fba222;}
	.sx_comments_re_button .sx_clicked1{width:auto;height:30px; background:url(<?php echo base_url();?>assets/images/cai-active.png) 0px 4px no-repeat; display:inline-block;color:#fba222; text-decoration:none; padding-left:18px; padding-top:2px;}
	...
	.sx_comments_re_button .sx_ding a:hover{background:url(<?php echo base_url();?>assets/images/ding-active.png) 0px 4px no-repeat;color:#fba222;}
	.sx_comments_re_button .sx_clicked2{width:16px;height:30px; background:url(<?php echo base_url();?>assets/images/ding-active.png) 0px 4px no-repeat; display:inline-block;color:#fba222; text-decoration:none; padding-left:12px; padding-top:2px;}
	...
	.sx_comments_re_button .sx_res a:hover{font-size:12px; text-decoration:none;color:#fba222;}
	...
	.sx_re_comments_forms_input textarea{width:100%; height:110px; outline:none; border:#fba222 1px solid; border-radius:12px; padding:8px 8px 8px 8px;color:#ccc;background:url(<?php echo base_url();?>assets/images/input_bg.png) center center no-repeat;resize:none;}
	...
	.sx_re_comments_forms_subs1 .sx_re_face_inner1 a{width:18px;height:18px;background: url(<?php echo base_url();?>assets/images/template/face_orange.jpg) no-repeat;display: inline-block;}
	.sx_re_comments_forms_subs1 .sx_re_face_comments_btn1{width:200px; float:right; height:auto; text-align:right;}
	.sx_re_face_comments_btn1 a{width: 102px;height: 30px;background: url(<?php echo base_url();?>assets/images/template/post-btn-chengse.jpg) no-repeat;display: inline-block;}
	.sx_re_face_comments_btn1 a:hover{width: 102px;height: 30px;background: url(<?php echo base_url();?>assets/images/template/post-btn-chengse2.jpg) no-repeat;display: inline-block;}
	.sx_hs_forms_face_re_position1{width:306px; height:auto; position:absolute;z-index:4; border:#fba222 1px solid; background:#FFF;padding-left:9px;padding-bottom:9px; border-radius:10px; margin-top:40px; display:none; margin-left:0px; padding-top:12px; padding-bottom:12px;}
	...
	.sx_comments_button .sx_caiyicai a:hover{width:auto;height:25px; background:url(<?php echo base_url();?>assets/images/cai-active.png) 0px 2px no-repeat; display:inline-block; padding-left:20px; text-decoration:none;color:#fba222;}
	.sx_comments_button .sx_caiyicai .sx_clicked1{width:auto;height:25px; background:url(<?php echo base_url();?>assets/images/cai-active.png) 0px 2px no-repeat; display:inline-block; padding-left:20px; text-decoration:none;color:#fba222;}
	...
	.sx_comments_button .sx_dingding a:hover{width:auto;height:25px; background:url(<?php echo base_url();?>assets/images/ding-active.png) 0px 2px no-repeat; display:inline-block;text-decoration:none;color:#fba222;padding-left:20px;}
	
	.sx_comments_button .sx_dingding .sx_clicked1{width:auto;height:25px; background:url(<?php echo base_url();?>assets/images/ding-active.png) 0px 2px no-repeat; display:inline-block;text-decoration:none;color:#fba222;padding-left:20px;}
	...
	.sx_comments_button .sx_retext a:hover{font-size:12px; text-decoration:none;color:#fba222;}
	...
	.sx_comments_img_lists .sx_img_zooms .sx_bars .sx_shouqilai a:hover{width:auto; background:url(<?php echo base_url();?>assets/images/pack-up-active.png) 0px 2px no-repeat; height:20px; padding-left:18px;font-size:12px; text-decoration:none;color:#999; display:inline-block;color:#fba222;}
	...
	.sx_comments_img_lists .sx_img_zooms .sx_bars .sx_yuantulook a:hover{width:auto; background:url(<?php echo base_url();?>assets/images/look-img-active.png) 0px 2px no-repeat; height:20px; padding-left:16px;font-size:12px; text-decoration:none;color:#999;display:inline-block;color:#fba222;}
	...
	*{ margin:0; padding: 0;}
	...
	.sx_mz{  float: left; font-size:14px; margin-top:2.4%; color: #fba222; width:25%}
	...
	.sx_plhfart a{ color: #fba222; font-size: 16px; text-decoration: none;}
	...
	.sx_reply1{ width: 98%; border: 1px #fba222 solid; border-radius:5px;  height: 80px;font-size: 16px; color: #ccc; font-family: "微软雅黑"; padding-left: 5px; padding-top: 0;     margin-bottom: 3%;} 
	.sx_reply2{ color: #fff; background-color: #fba222; border-radius:4px; width: 12%; padding: 1% 0; font-size:16px; float: right; border: 0;font-family: "微软雅黑";}
