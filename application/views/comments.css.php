...
.sx_hs_comments {margin:0 auto;height:auto;width:100%;font-size:14px;}
...
.sx_hs_comments div,.sx_hs_comments td,.sx_hs_comments th,.sx_hs_comments textarea,.sx_hs_comments input,.sx_hc_comments_box {font-family:"微软雅黑";font-size:14px;}
...
.sx_hs_comments .sx_comments_submit a {width:102px;height:30px;background:url(http://pinglun.999junyi.com/assets/images/post-btn.png) no-repeat;display:inline-block;}
.sx_hs_comments .sx_comments_submit a:hover {width:102px;height:30px;background:url(http://pinglun.999junyi.com/assets/images/post-btn-hover.png) no-repeat;display:inline-block;}
.sx_hs_box {width:100%;float:left;height:auto;padding-bottom:12px;}
.sx_hs_forms {width:100%;float:left;height:40px;}
.sx_hs_forms_login {width:40px;height:40px;border-radius:50%;text-align:center;border:#3ba33a 1px solid;font-size:16px;line-height:40px;color:#3ba33a;margin-left:12px;position:absolute;z-index:4;margin-top:3px;background:#FFF;cursor:pointer;}
.sx_hs_forms_login_avatar {width:40px;height:40px;text-align:center;font-size:16px;color:#3ba33a;margin-left:12px;position:absolute;z-index:4;margin-top:3px;background:#FFF;cursor:pointer;display:none;border-radius:50%;}
...
.sx_hs_comments .sx_inputcomments {width:100%;float:left;height:auto;border:#3ba33a 1px solid;border-radius:8px;padding-top:18px;position:relative;z-index:1;background:#FFF;}
.sx_hs_forms_face {width:30px;float:left;height:30px;padding-top:18px;padding-left:15px;}
.sx_hs_forms_face a {width:18px;height:18px;background:url(http://pinglun.999junyi.com/assets/images/face.png) no-repeat;display:inline-block;}
.sx_hs_forms_face a:hover {width:18px;height:18px;background:url(http://pinglun.999junyi.com/assets/images/face-active.png) no-repeat;display:inline-block;}
...
.sx_hs_comments_lists .sx_item_title {position:absolute;z-index:2;width:70px;line-height:30px;border:#3ba33a 1px solid;border-top-right-radius:8px;background:#fff;border-bottom:none;border-top-left-radius:8px;text-align:center;color:#3ba33a;font-size:16px;}
.sx_hs_comments_lists .sx_item_line {line-height:30px;height:30px;position:relative;overflow:hidden;border-bottom:#3ba33a 1px solid;text-align:right;color:#3ba33a;}
.sx_hs_comments_start {width:100%;float:left;height:auto;padding-top:20px;}
.sx_hs_comments_start .sx_comments_alts {width:100px;float:left;padding-left:15px;text-align:left;line-height:55px;font-size:16px;font-weight:blod;color:#3ba33a;}
...
.sx_hs_comments_nickname {width:110px;float:left;height:30px;line-height:30px;color:#3ba33a;font-size:12px;overflow:hidden;}
.sx_hs_comments_nickname a {color:#3ba33a;font-size:12px;text-decoration:none;}
.sx_hs_comments_nickname a:hover {color:#3ba33a;font-size:12px;text-decoration:none;}
...
.sx_get_passwds a:hover {width:85px;line-height:35px;height:35px;border:#38a3fd 1px solid;background:#38a3fd;border-radius:8px;padding-left:2%;display:inline-block;text-decoration:none;text-align:center;color:#fff;font-size:14px;}
...
.sx_comments_other_login .sx_qq a {width:40px;height:40px;background:url(http://pinglun.999junyi.com/assets/images/login-group.png) 0px -80px no-repeat;display:inline-block;margin-right:15px;}
.sx_comments_other_login .sx_qq a:hover {width:40px;height:40px;background:url(http://pinglun.999junyi.com/assets/images/login-group.png) -40px -80px no-repeat;display:inline-block;margin-right:15px;}
.sx_comments_other_login .sx_sina a {width:40px;height:40px;background:url(http://pinglun.999junyi.com/assets/images/login-group.png) 0px -40px no-repeat;display:inline-block;margin-right:15px;}
.sx_comments_other_login .sx_sina a:hover {width:40px;height:40px;background:url(http://pinglun.999junyi.com/assets/images/login-group.png) -40px -40px no-repeat;display:inline-block;margin-right:15px;}
.sx_comments_other_login .sx_phone a {width:40px;height:40px;background:url(http://pinglun.999junyi.com/assets/images/login-group.png) 0px -120px no-repeat;display:inline-block;}
.sx_comments_other_login .sx_phone a:hover {width:40px;height:40px;background:url(http://pinglun.999junyi.com/assets/images/login-group.png) -40px -120px no-repeat;display:inline-block;}
.sx_comments_login_history {width:100%;float:left;text-align:center;padding-top:15px;color:#999;font-size:12px;}
.sx_hs_forms_login_down {width:45px;height:40px;border-radius:50%;background:#FFF;position:absolute;z-index:2;border:#3ba33a 1px solid;margin-left:10px;margin-top:10px;}
.sx_hs_forms_login_down_bg {width:70px;height:40px;background:#fff;position:absolute;z-index:3;margin-left:10px;}
.sx_hs_forms_login_nickname {width:auto;height:40px;line-height:40px;text-align:center;background:#FFF;position:absolute;z-index:5;margin-left:70px;margin-top:20px;padding-left:10px;padding-right:10px;color:#3ba33a;display:none;}
.sx_comments_login_my1 a {background:url(http://pinglun.999junyi.com/assets/images/tab-list-icon-active1.png) 10px 0px no-repeat;width:44px;height:auto;display:inline-block;color:#38a3fd;text-decoration:none;padding-top:23px;font-size:12px;text-align:center;margin-top:20px;}
.sx_comments_login_my a {background:url(http://pinglun.999junyi.com/assets/images/tab-list-icon1.png) 10px 0px no-repeat;width:44px;height:auto;display:inline-block;color:#999;text-decoration:none;padding-top:23px;font-size:12px;text-align:center;margin-top:20px;}
.sx_comments_login_my a:hover {background:url(http://pinglun.999junyi.com/assets/images/tab-list-icon-active1.png) 10px 0px no-repeat;width:44px;height:auto;display:inline-block;color:#38a3fd;text-decoration:none;padding-top:23px;font-size:12px;text-align:center;margin-top:20px;}
.sx_comments_login_task1 a {background:url(http://pinglun.999junyi.com/assets/images/task-ico-active.png) 10px 0px no-repeat;width:44px;height:auto;display:inline-block;color:#38a3fd;text-decoration:none;padding-top:23px;font-size:12px;text-align:center;margin-top:20px;}
.sx_comments_login_task a {background:url(http://pinglun.999junyi.com/assets/images/task-ico.png) 10px 0px no-repeat;width:44px;height:auto;display:inline-block;color:#999;text-decoration:none;padding-top:23px;font-size:12px;text-align:center;margin-top:20px;}
.sx_comments_login_task a:hover {background:url(http://pinglun.999junyi.com/assets/images/task-ico-active.png) 10px 0px no-repeat;width:44px;height:auto;display:inline-block;color:#38a3fd;text-decoration:none;padding-top:23px;font-size:12px;text-align:center;margin-top:20px;}
.sx_comments_login_msg1 a {background:url(http://pinglun.999junyi.com/assets/images/set-icon-active.png) 10px 0px no-repeat;width:44px;height:auto;display:inline-block;color:#38a3fd;text-decoration:none;padding-top:23px;font-size:12px;text-align:center;margin-top:20px;}
.sx_comments_login_msg a {background:url(http://pinglun.999junyi.com/assets/images/set-icon.png) 10px 0px no-repeat;width:44px;height:auto;display:inline-block;color:#999;text-decoration:none;padding-top:23px;font-size:12px;text-align:center;margin-top:20px;}
.sx_comments_login_msg a:hover {background:url(http://pinglun.999junyi.com/assets/images/set-icon-active.png) 10px 0px no-repeat;width:44px;height:auto;display:inline-block;color:#38a3fd;text-decoration:none;padding-top:23px;font-size:12px;text-align:center;margin-top:20px;}
...
.sx_plugins_nickname a {background:url(http://pinglun.999junyi.com/assets/images/edit.png) right no-repeat;width:auto;display:inline-block;padding-right:30px;height:30px;line-height:30px;text-align:center;color:#000;text-decoration:none;font-size:12px;}
...
.sx_plugins_nickname1 a {background:url(http://pinglun.999junyi.com/assets/images/edit.png) 0px 0px no-repeat;width:20px;height:20px;display:inline-block;}
...
#hs_forms_face_position {width:306px;height:auto;position:absolute;z-index:4;border:#0C9 1px solid;background:#FFF;padding-left:9px;padding-bottom:9px;border-radius:10px;margin-top:30px;display:none;}
...
.sx_hs_forms_face_re_position {width:306px;height:auto;position:absolute;z-index:4;border:#0C9 1px solid;background:#FFF;padding-left:9px;padding-bottom:9px;border-radius:10px;margin-top:30px;display:none;margin-left:10px;padding-top:12px;padding-bottom:12px;}
...
.sx_re_comments_textarea textarea {width:100%;height:110px;outline:none;border:#0C9 1px solid;border-radius:12px;padding:8px 8px 8px 8px;color:#ccc;background:url(http://pinglun.999junyi.com/assets/images/input_bg.png) center center no-repeat;resize:none;}
.sx_re_comments_subs {width:100%;height:auto;float:left;}
.sx_re_face_inner {width:40px;float:left;height:auto;padding-left:10px;}
.sx_re_face_inner a {width:18px;height:18px;background:url(http://pinglun.999junyi.com/assets/images/face.png) no-repeat;display:inline-block;}
.sx_re_face_inner a:hover {width:18px;height:18px;background:url(http://pinglun.999junyi.com/assets/images/face-active.png) no-repeat;display:inline-block;}
.sx_re_face_comments_btn {width:200px;float:right;height:auto;text-align:right;}
.sx_re_face_comments_btn a {width:102px;height:30px;background:url(http://pinglun.999junyi.com/assets/images/post-btn.png) no-repeat;display:inline-block;}
.sx_re_face_comments_btn a:hover {width:102px;height:30px;background:url(http://pinglun.999junyi.com/assets/images/post-btn-hover.png) no-repeat;display:inline-block;}
...
.sx_hc_comments_re_item .sx_members_infos .sx_nickname {width:100px;float:left;height:30px;line-height:30px;font-size:12px;color:#3ba33a;}
.sx_hc_comments_re_item .sx_members_infos .sx_nickname a {color:#3ba33a;text-decoration:none;}
.sx_hc_comments_re_item .sx_members_infos .sx_nickname a:hover {color:#3ba33a;text-decoration:underline;}
...
.sx_comments_re_button .sx_cai a {width:auto;height:30px;background:url(http://pinglun.999junyi.com/assets/images/cai.png) 0px 4px no-repeat;display:inline-block;color:#999;text-decoration:none;padding-left:18px;padding-top:2px;}
.sx_comments_re_button .sx_cai a:hover {background:url(http://pinglun.999junyi.com/assets/images/cai-active.png) 0px 4px no-repeat;color:#3ba33a;}
.sx_comments_re_button .sx_clicked1 {width:auto;height:30px;background:url(http://pinglun.999junyi.com/assets/images/cai-active.png) 0px 4px no-repeat;display:inline-block;color:#3ba33a;text-decoration:none;padding-left:18px;padding-top:2px;}
.sx_comments_re_button .sx_ding {width:auto;float:right;height:auto;margin-left:20px;}
.sx_comments_re_button .sx_ding a {width:auto;height:30px;background:url(http://pinglun.999junyi.com/assets/images/ding.png) 0px 4px no-repeat;display:inline-block;color:#999;text-decoration:none;padding-left:19px;padding-top:2px;}
.sx_comments_re_button .sx_ding a:hover {background:url(http://pinglun.999junyi.com/assets/images/ding-active.png) 0px 4px no-repeat;color:#3ba33a;}
.sx_comments_re_button .sx_clicked2 {width:16px;height:30px;background:url(http://pinglun.999junyi.com/assets/images/ding-active.png) 0px 4px no-repeat;display:inline-block;color:#3ba33a;text-decoration:none;padding-left:12px;padding-top:2px;}
...
.sx_comments_re_button .sx_res a:hover {font-size:12px;text-decoration:none;color:#3ba33a;}
...
.sx_re_comments_forms_input textarea {width:100%;height:110px;outline:none;border:#0C9 1px solid;border-radius:12px;padding:8px 8px 8px 8px;color:#ccc;background:url(http://pinglun.999junyi.com/assets/images/input_bg.png) center center no-repeat;resize:none;}
...
.sx_re_comments_forms_subs1 .sx_re_face_inner1 a {width:18px;height:18px;background:url(http://pinglun.999junyi.com/assets/images/face.png) no-repeat;display:inline-block;}
.sx_re_comments_forms_subs1 .sx_re_face_comments_btn1 {width:200px;float:right;height:auto;text-align:right;}
.sx_re_face_comments_btn1 a {width:102px;height:30px;background:url(http://pinglun.999junyi.com/assets/images/post-btn.png) no-repeat;display:inline-block;}
.sx_re_face_comments_btn1 a:hover {width:102px;height:30px;background:url(http://pinglun.999junyi.com/assets/images/post-btn-hover.png) no-repeat;display:inline-block;}
.sx_hs_forms_face_re_position1 {width:306px;height:auto;position:absolute;z-index:4;border:#0C9 1px solid;background:#FFF;padding-left:9px;padding-bottom:9px;border-radius:10px;margin-top:40px;display:none;margin-left:0px;padding-top:12px;padding-bottom:12px;}
...
.sx_comments_button .sx_gaizhang a {width:21px;height:25px;background:url(http://pinglun.999junyi.com/assets/images/prop-ico.png) no-repeat 0px 2px;display:inline-block;}
.sx_comments_button .sx_caiyicai {width:auto;float:right;padding-left:5px;padding-right:15px;padding-top:5px;}
.sx_comments_button .sx_caiyicai a {width:auto;height:25px;background:url(http://pinglun.999junyi.com/assets/images/cai.png) 0px 2px no-repeat;display:inline-block;padding-left:20px;text-decoration:none;color:#999;}
.sx_comments_button .sx_caiyicai a:hover {width:auto;height:25px;background:url(http://pinglun.999junyi.com/assets/images/cai-active.png) 0px 2px no-repeat;display:inline-block;padding-left:20px;text-decoration:none;color:#3ba33a;}
.sx_comments_button .sx_caiyicai .sx_clicked1 {width:auto;height:25px;background:url(http://pinglun.999junyi.com/assets/images/cai-active.png) 0px 2px no-repeat;display:inline-block;padding-left:20px;text-decoration:none;color:#3ba33a;}
...
.sx_comments_button .sx_dingding a {width:auto;height:25px;background:url(http://pinglun.999junyi.com/assets/images/ding.png) 0px 2px no-repeat;display:inline-block;text-decoration:none;color:#999;padding-left:20px;}
.sx_comments_button .sx_dingding a:hover {width:auto;height:25px;background:url(http://pinglun.999junyi.com/assets/images/ding-active.png) 0px 2px no-repeat;display:inline-block;text-decoration:none;color:#3ba33a;padding-left:20px;}
.sx_comments_button .sx_dingding .sx_clicked1 {width:auto;height:25px;background:url(http://pinglun.999junyi.com/assets/images/ding-active.png) 0px 2px no-repeat;display:inline-block;text-decoration:none;color:#3ba33a;padding-left:20px;}
...
.sx_comments_button .sx_retext a:hover {font-size:12px;text-decoration:none;color:#3ba33a;}
...
.sx_comments_img_lists .sx_img_zooms .sx_bars .sx_shouqilai a {width:auto;background:url(http://pinglun.999junyi.com/assets/images/pack-up.png) 0px 2px no-repeat;height:20px;padding-left:18px;font-size:12px;text-decoration:none;color:#999;display:inline-block;}
.sx_comments_img_lists .sx_img_zooms .sx_bars .sx_shouqilai a:hover {width:auto;background:url(http://pinglun.999junyi.com/assets/images/pack-up-active.png) 0px 2px no-repeat;height:20px;padding-left:18px;font-size:12px;text-decoration:none;color:#999;display:inline-block;color:#3ba33a;}
.sx_comments_img_lists .sx_img_zooms .sx_bars span {display:inline-block;padding-left:10px;padding-right:10px;}
.sx_comments_img_lists .sx_img_zooms .sx_bars .sx_yuantulook a {width:auto;background:url(http://pinglun.999junyi.com/assets/images/look-img.png) 0px 2px no-repeat;height:20px;padding-left:16px;font-size:12px;text-decoration:none;color:#999;display:inline-block;}
.sx_comments_img_lists .sx_img_zooms .sx_bars .sx_yuantulook a:hover {width:auto;background:url(http://pinglun.999junyi.com/assets/images/look-img-active.png) 0px 2px no-repeat;height:20px;padding-left:16px;font-size:12px;text-decoration:none;color:#999;display:inline-block;color:#3ba33a;}
...
.sx_commentsAll a {color:#999;text-decoration:none;display:inline-block;width:auto;background:url(http://pinglun.999junyi.com/assets/images/commentsNoChoose.png) 0px 9px no-repeat;padding-left:16px;padding-right:10px;line-height:30px;height:30px;font-size:13px;}
.sx_commentsAll a label {color:#333;cursor:pointer;}
.sx_commentsAll1 a {color:#999;text-decoration:none;display:inline-block;width:auto;background:url(http://pinglun.999junyi.com/assets/images/commentsChoose.png) 0px 9px no-repeat;padding-left:16px;padding-right:10px;line-height:30px;height:30px;font-size:13px;}
.sx_commentsAll1 a label {color:#333;cursor:pointer;}
.sx_commentsBest {margin-left:10px;display:inline-block;}
.sx_commentsBest a {color:#999;text-decoration:none;display:inline-block;width:auto;background:url(http://pinglun.999junyi.com/assets/images/commentsNoChoose.png) 0px 9px no-repeat;padding-left:16px;padding-right:10px;line-height:30px;height:30px;font-size:13px;}
.sx_commentsBest a label {color:#333;cursor:pointer;}
.sx_commentsBest1 {margin-left:10px;display:inline-block;}
.sx_commentsBest1 a {color:#999;text-decoration:none;display:inline-block;width:auto;background:url(http://pinglun.999junyi.com/assets/images/commentsChoose.png) 0px 9px no-repeat;padding-left:16px;padding-right:10px;line-height:30px;height:30px;font-size:13px;}
.sx_commentsBest1 a label {color:#333;cursor:pointer;}
.sx_commentsMedium {margin-left:10px;display:inline-block;}
.sx_commentsMedium a {color:#999;text-decoration:none;display:inline-block;width:auto;background:url(http://pinglun.999junyi.com/assets/images/commentsNoChoose.png) 0px 9px no-repeat;padding-left:16px;padding-right:10px;line-height:30px;height:30px;font-size:13px;}
.sx_commentsMedium1 {margin-left:10px;display:inline-block;}
.sx_commentsMedium a label {color:#333;cursor:pointer;}
.sx_commentsMedium1 a {color:#999;text-decoration:none;display:inline-block;width:auto;background:url(http://pinglun.999junyi.com/assets/images/commentsChoose.png) 0px 9px no-repeat;padding-left:16px;padding-right:10px;line-height:30px;height:30px;font-size:13px;}
.sx_commentsMedium1 a label {color:#333;cursor:pointer;}
.sx_commentsNegative {margin-left:10px;display:inline-block;}
.sx_commentsNegative a {color:#999;text-decoration:none;display:inline-block;width:auto;background:url(http://pinglun.999junyi.com/assets/images/commentsNoChoose.png) 0px 9px no-repeat;padding-left:16px;padding-right:10px;line-height:30px;height:30px;font-size:13px;}
.sx_commentsNegative a label {color:#333;cursor:pointer;}
.sx_commentsNegative1 {margin-left:10px;display:inline-block;}
.sx_commentsNegative1 a {color:#999;text-decoration:none;display:inline-block;width:auto;background:url(http://pinglun.999junyi.com/assets/images/commentsChoose.png) 0px 9px no-repeat;padding-left:16px;padding-right:10px;line-height:30px;height:30px;font-size:13px;}
...
.sx_mz {float:left;font-size:14px;margin-top:2.4%;color:#3ba33a;width:25%}
.sx_plri {float:right;margin-top:2.4%;width:58%;}
.sx_plri span {text-align:right;display:block;}
.sx_plri span img {margin:0% 0%; vertical-align: middle;}
.sx_plri i {color:#b0adad;font-size:14px;margin-left:2.2%;float:right;font-style:normal; line-height: 2}
...
.sx_click span {color:#b2b2b2;padding-left:2%;vertical-align:middle;}
...
.sx_plhfart a {color:#3ba33a;font-size:16px;text-decoration:none;}
...
.sx_reply1 {width:98%;border:1px #3ba33a solid;border-radius:5px;height:80px;font-size:16px;color:#ccc;font-family:"微软雅黑";padding-left:5px;padding-top:0;margin-bottom:3%;}
.sx_reply2 {color:#fff;background-color:#3ba33a;border-radius:4px;width:12%;padding:1% 0;font-size:16px;float:right;border:0;font-family:"微软雅黑";}
