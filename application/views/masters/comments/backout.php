...
<article class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tbody>
			<tr>
			  <td width="164" height="38" style="text-align:center">下载地址：</td>
			  <td width="760" align="left" valign="middle" style="text-align:left;" id="download_inner"><font color="#999999">请执行导出数据任务...</font></td>
		  </tr>
          </span>
			<tr class="text-c" >
			  <td colspan="2" align="center" valign="middle">
              
              <button onClick="article_save_submit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 开 始 导 出 数 据 ...   </button>
              </td>
		  </tr>
...
<script>
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			layer.closeAll();
			form_loads=2;	
			$.ajax({url:"<?php echo masters_url();?>comments/outres", 
			type: 'POST', 
				...
				success:function(result){
					...
					if(result.indexOf("|")>0){
						...
						if(arr[0]==100){
							...
							$("#download_inner").html('<a href="<?php echo masters_url();?>comments/downloads/<?php echo $site_id;?>">点击下载</a>');
						}else if(arr[0]==200){
