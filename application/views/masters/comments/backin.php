...
<script>
	...
	function stopUpload(result){
		...
		if(result.indexOf("|")>0){
			...
			if(arr[0]==100){
				layer.msg('导入成功');
				setTimeout("location='<?php echo masters_url();?>comments/index?keywords='",1500);
			}else if(arr[0]==200){
				layer.msg('登录状态已失效');		
...
<form id="recsons" name="recsons" action="<?php echo masters_url();?>comments/backinsert/<?php echo $site_id;?>" method="post" enctype="multipart/form-data" class="definewidth m20" target="upload_target1">
<article class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tbody>
			...
			<tr>
			  <td width="177" height="40" style="text-align:center;">来自畅言：</td>
			  <td width="826" height="40" align="left" valign="middle" style="text-align:left;"><input type="radio" name="froms" id="froms" value="1" checked>
			    否 
			      　　
			      <input type="radio" name="froms" id="froms" value="2">		        是</td>
		  </tr>

          <tr >
			  <td height="40" align="center" valign="middle" style=" text-align:center;">对应文件：</td>
			...
			<tr class="text-c" >
              ...
              <button onClick="article_save_submit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 点 击 开 始 导 入   </button>
              </td>
		  </tr>
