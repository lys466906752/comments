...
<script>
	...
	function changeSite()
	{
		var site_v=$("#site_v").val();
		if(site_v!='' && site_v!=0)
		{
			$.ajax({url:"<?php echo masters_url();?>home/changes/" + site_v, 
				type: 'GET', 
				dataType: 'html', 
				timeout: 15000, 
				error: function(){
					layer.msg("网络连接超时，请稍后再试！");
				},
				beforeSend:function(){
				...
				success:function(result){
						...
						if(result.indexOf("|")>0){
							...
							if(arr[0]==100){
								...
								location='<?php echo masters_url();?>home/index';	
	...
	function clear_rubbish()
	{
		if(form_status==0 || form_status==3){
			$.ajax({url:"<?php echo masters_url();?>home/rubbishs", 
			type: 'GET', 
			dataType: 'html', 
			timeout: 15000, 
				error: function(){
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="<?php echo $_SERVER['REQUEST_URI'];?>">军颐评论单例管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="<?php echo $_SERVER['REQUEST_URI'];?>">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v1.0</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>


			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
                	<li style="padding-right:20px;">
                    <select id="site_v" name="site_v" onChange="changeSite();">
                    	<option value="">--请选择对应的站点--</option>
                        <?php
                        	foreach($query->result_array() as $array)
							{
						?>
                        <option value="<?php echo $array['id'];?>" <?php if($site_id && $site_id==$array['id']){?> selected<?php }?>><?php echo $array['name'];?> <?php echo $array['url'];?></option>
                        <?php
                        	}
						?>
					...
					<li>单例站点管理员</li>
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A"><?php echo $this->adminInfos["mobile"];?> <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:system_fo();">修改资料</a></li>
                            <li><a href="javascript:clear_rubbish();">清除缓存</a></li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo masters_url();?>comments/index" data-title="评论管理" href="javascript:void(0)">评论管理</a></li>
                    <li><a _href="<?php echo masters_url();?>comments/res" data-title="回复管理" href="javascript:void(0)">回复管理</a></li>
                    <li><a _href="<?php echo masters_url();?>comments/backout" data-title="导出数据" href="javascript:void(0)">导出数据</a></li>
                    <li><a _href="<?php echo masters_url();?>comments/backin" data-title="导入数据" href="javascript:void(0)">导入数据</a></li>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
                    <li><a _href="<?php echo masters_url();?>sites/index" data-title="站点列表" href="javascript:void(0)">站点列表</a></li>
                    <li><a _href="<?php echo masters_url();?>members/passwd" data-title="修改资料" href="javascript:void(0)" id="sysr" style="display:none;">修改资料</a></li>
				</ul>
			</dd>
		</dl>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="<?php echo masters_url();?>home/welcome"></iframe>
		</div>
	</div>
</section>
