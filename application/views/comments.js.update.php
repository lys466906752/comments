<script>
	...
	function createReItem(obj)
	{
		...
		{
			returnHtml=returnHtml + '<div><article class="sx_plhfart"><a href="javascript:show_members_infos(\'' + obj[i].uid + '\');">' + obj[i].uname + '</a>：</article><p>' + obj[i].fulltext + ' </p><img src="<?php echo base_url();?>assets/images/sxpl.png" class="sx_pl" alt="" onclick="showReInputs(\'' + obj[i].id + '\',\'' + obj[i].aid + '\')" /></div><div class="sx_plreply" id="sxTowHtml_' + obj[i].id + 'b_c' + obj[i].aid + '"><textarea placeholder="就医体验如何？把感受告诉更多人"  class="sx_reply1" id="sxTow_' + obj[i].id + 'b_c' + obj[i].aid + '"/></textarea>' + createFaceHtmlOne(obj[i].id,obj[i].aid) + '<p><a href="javascript:showFaceOne(\'' + obj[i].id + '\',\'' + obj[i].aid + '\');"><img src="<?php echo base_url();?>assets/images/face.png" alt="" /></a><input type="submit" value="发表" class="sx_reply2" onclick="subReItemOne(\'' + obj[i].id + '\',\'' + obj[i].aid + '\')" /></p></div>';	
	...
	function createReItemEnd(obj)
	{
		...
		for(var i=0;i<obj.length;i++)
		{
			returnHtml=returnHtml + '<div><article class="sx_plhfart"><a href="javascript:show_members_infos(\'' + obj[i].uid + '\');">' + obj[i].uname + '</a> <span> 回复 </span><a href="javascript:show_members_infos(\'' + obj[i].rid + '\');">' + obj[i].rname + '</a>：</article><p>' + obj[i].fulltext + ' </p><img src="<?php echo base_url();?>assets/images/sxpl.png" class="sx_pl" alt="" onclick="showReInputs(\'' + obj[i].id + '\',\'' + obj[i].aid + '\')" /></div><div class="sx_plreply" id="sxTowHtml_' + obj[i].id + 'b_c' + obj[i].aid + '"><textarea placeholder="就医体验如何？把感受告诉更多人"  class="sx_reply1" id="sxTow_' + obj[i].id + 'b_c' + obj[i].aid + '"/></textarea>' + createFaceHtmlOne(obj[i].id,obj[i].aid) + '<p><a href="javascript:showFaceOne(\'' + obj[i].id + '\',\'' + obj[i].aid + '\');"><img src="<?php echo base_url();?>assets/images/face.png" alt="" /></a><input type="submit" value="发表" class="sx_reply2" onclick="subReItemTow(\'' + obj[i].id + '\',\'' + obj[i].aid + '\',\'' + obj[i].upid + '\')" /></p></div>';			
		}	
