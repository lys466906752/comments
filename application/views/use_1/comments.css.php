<style type="text/css">
	...
	.sx_hs_comments .sx_comments_submit a{width:102px; height:30px; background:url(<?php echo base_url();?>assets/images/post-btn.png) no-repeat; display:inline-block;}
	.sx_hs_comments .sx_comments_submit a:hover{width:102px; height:30px; background:url(<?php echo base_url();?>assets/images/post-btn-hover.png) no-repeat; display:inline-block;}
	...
	.sx_hs_forms_face a{width:18px;height:18px; background:url(<?php echo base_url();?>assets/images/face.png) no-repeat; display:inline-block;}
	.sx_hs_forms_face a:hover{width:18px;height:18px; background:url(<?php echo base_url();?>assets/images/face-active.png) no-repeat; display:inline-block;}
	...
	.sx_re_comments_textarea textarea{width:100%; height:110px; outline:none; border:#0C9 1px solid; border-radius:12px; padding:8px 8px 8px 8px;color:#ccc;background:url(<?php echo base_url();?>assets/images/input_bg.png) center center no-repeat;resize:none;}
	.sx_re_comments_subs{width:100%; height:auto; float:left;}
	.sx_re_face_inner{width:40px; float:left; height:auto; padding-left:10px;}
	.sx_re_face_inner a{width:18px;height:18px;background: url(<?php echo base_url();?>assets/images/face.png) no-repeat;display: inline-block;}
	.sx_re_face_inner a:hover{width:18px;height:18px;background: url(<?php echo base_url();?>assets/images/face-active.png) no-repeat;display: inline-block;}
	.sx_re_face_comments_btn{width:200px; float:right; height:auto; text-align:right;}
	.sx_re_face_comments_btn a{width: 102px;height: 30px;background: url(<?php echo base_url();?>assets/images/post-btn.png) no-repeat;display: inline-block;}
	.sx_re_face_comments_btn a:hover{width: 102px;height: 30px;background: url(<?php echo base_url();?>assets/images/post-btn-hover.png) no-repeat;display: inline-block;}
	...
	.sx_comments_re_button .sx_cai a:hover{background:url(<?php echo base_url();?>assets/images/cai-active.png) 0px 4px no-repeat;color:#3ba33a;}
	.sx_comments_re_button .sx_clicked1{width:auto;height:30px; background:url(<?php echo base_url();?>assets/images/cai-active.png) 0px 4px no-repeat; display:inline-block;color:#3ba33a; text-decoration:none; padding-left:18px; padding-top:2px;}
	...
	.sx_comments_re_button .sx_ding a:hover{background:url(<?php echo base_url();?>assets/images/ding-active.png) 0px 4px no-repeat;color:#3ba33a;}
	.sx_comments_re_button .sx_clicked2{width:16px;height:30px; background:url(<?php echo base_url();?>assets/images/ding-active.png) 0px 4px no-repeat; display:inline-block;color:#3ba33a; text-decoration:none; padding-left:12px; padding-top:2px;}
	...
	.sx_re_comments_forms_input textarea{width:100%; height:110px; outline:none; border:#0C9 1px solid; border-radius:12px; padding:8px 8px 8px 8px;color:#ccc;background:url(<?php echo base_url();?>assets/images/input_bg.png) center center no-repeat;resize:none;}
	...
	.sx_re_comments_forms_subs1 .sx_re_face_inner1 a{width:18px;height:18px;background: url(<?php echo base_url();?>assets/images/face.png) no-repeat;display: inline-block;}
	.sx_re_comments_forms_subs1 .sx_re_face_comments_btn1{width:200px; float:right; height:auto; text-align:right;}
	.sx_re_face_comments_btn1 a{width: 102px;height: 30px;background: url(<?php echo base_url();?>assets/images/post-btn.png) no-repeat;display: inline-block;}
	.sx_re_face_comments_btn1 a:hover{width: 102px;height: 30px;background: url(<?php echo base_url();?>assets/images/post-btn-hover.png) no-repeat;display: inline-block;}
	...
	.sx_comments_button .sx_caiyicai a:hover{width:auto;height:25px; background:url(<?php echo base_url();?>assets/images/cai-active.png) 0px 2px no-repeat; display:inline-block; padding-left:20px; text-decoration:none;color:#3ba33a;}
	.sx_comments_button .sx_caiyicai .sx_clicked1{width:auto;height:25px; background:url(<?php echo base_url();?>assets/images/cai-active.png) 0px 2px no-repeat; display:inline-block; padding-left:20px; text-decoration:none;color:#3ba33a;}
	...
	.sx_comments_button .sx_dingding a:hover{width:auto;height:25px; background:url(<?php echo base_url();?>assets/images/ding-active.png) 0px 2px no-repeat; display:inline-block;text-decoration:none;color:#3ba33a;padding-left:20px;}
	
	.sx_comments_button .sx_dingding .sx_clicked1{width:auto;height:25px; background:url(<?php echo base_url();?>assets/images/ding-active.png) 0px 2px no-repeat; display:inline-block;text-decoration:none;color:#3ba33a;padding-left:20px;}
	...
	.sx_comments_img_lists .sx_img_zooms .sx_bars .sx_shouqilai a:hover{width:auto; background:url(<?php echo base_url();?>assets/images/pack-up-active.png) 0px 2px no-repeat; height:20px; padding-left:18px;font-size:12px; text-decoration:none;color:#999; display:inline-block;color:#3ba33a;}
	...
	.sx_comments_img_lists .sx_img_zooms .sx_bars .sx_yuantulook a:hover{width:auto; background:url(<?php echo base_url();?>assets/images/look-img-active.png) 0px 2px no-repeat; height:20px; padding-left:16px;font-size:12px; text-decoration:none;color:#999;display:inline-block;color:#3ba33a;}
