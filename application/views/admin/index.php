...
<script>
	...
	function clear_rubbish()
	{
		if(form_status==0 || form_status==3){
			$.ajax({url:"<?php echo admin_url();?>systems/rubbishs", 
			type: 'GET', 
			dataType: 'html', 
			timeout: 15000, 
				error: function(){
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="<?php echo $_SERVER['REQUEST_URI'];?>">军颐评论管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="<?php echo $_SERVER['REQUEST_URI'];?>">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v1.0</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
				...
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A"><?php echo $this->adminInfos["username"];?> <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li><a href="javascript:clear_rubbish();">垃圾清理</a></li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> 表情包设置<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
                    <li><a _href="<?php echo admin_url();?>faces/index" data-title="表情包列表" href="javascript:void(0)">表情包列表</a></li>
				</ul>
			</dd>
		</dl>
        <!--<dl id="menu-article100">
			<dt><i class="Hui-iconfont">&#xe610;</i> 任务设置<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="<?php echo admin_url();?>awards/index" data-title="任务配置" href="javascript:void(0)">任务配置</a></li>
        ...
        <!--
		<dl id="menu-picture">
			<dt><i class="Hui-iconfont">&#xe613;</i> 印章设置<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="<?php echo admin_url();?>yins/index" data-title="印章管理" href="javascript:void(0)">印章管理</a></li>
		...
		<dl id="menu-admin">
			<dt><i class="Hui-iconfont">&#xe62d;</i> 站点信息设置<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="<?php echo admin_url();?>masters/index" data-title="站点管理员" href="javascript:void(0)">站点管理员</a></li>
                    <li><a _href="<?php echo admin_url();?>masters/sites" data-title="站点列表" href="javascript:void(0)">站点列表</a></li>
                    <li><a _href="<?php echo admin_url();?>members/index" data-title="会员管理" href="javascript:void(0)">会员管理</a></li>
                    <li><a _href="<?php echo admin_url();?>admins/passwd" data-title="修改密码" href="javascript:void(0)" id="sysr" style="display:none;">修改密码</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo admin_url();?>systems/index" data-title="系统设置" href="javascript:void(0)">系统设置</a></li>
                    <li><a _href="<?php echo admin_url();?>systems/avatar" data-title="默认头像" href="javascript:void(0)">默认头像</a></li>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="<?php echo admin_url();?>admins/welcome"></iframe>
		</div>
	</div>
</section>
