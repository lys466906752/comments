...
<form id="recsons" name="recsons" action="<?php echo admin_url();?>yins/index_update/<?php echo $result['id'];?>" method="post" enctype="multipart/form-data" class="definewidth m20" target="upload_target1">
<article class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tbody>
			...
			<tr class="text-c" >
			  <td width="177">印章名称：</td>
			  <td width="826" align="left" valign="middle">
              <input type="text" class="input-text" value="<?php echo $result['name'];?>" placeholder="请填写印章名称，10个字以内" id="name" name="name">
              </td>
		  </tr>
            <tr >
              <td align="center" valign="middle" style=" text-align:center;">所需金额：</td>
              <td align="left" valign="middle">
               <input type="text" class="input-text" value="<?php echo $result['money'];?>" placeholder="必须填写整形数字" id="award" name="award" style="ime-mode:disabled">
              </td>
          </tr>
          <tr >
              <td align="center" valign="middle" style=" text-align:center;">印章图预览：</td>
