	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<tbody>
			...
			<tr >
			  ...
			  <td align="left" valign="middle"><input type="radio" name="addType" id="addType" checked value="1" onClick="showShow();">
			    从现有会员中添加 
			      　　
			      <input type="radio" name="addType" id="addType" value="2" onClick="showShow();">
			      设置一个新的会员</td>
		  </tr>
	...
	function article_save_submit()
	{
		...
		if(form_loads==1)
		{
			...
			else
			{
				...
				form_loads=2;	
				$.ajax({url:"<?php echo admin_url();?>masters/inserts", 
				type: 'POST', 
					...
					success:function(result){
						...
						if(result.indexOf("|")>0){
							...
							if(arr[0]==100){
								...
								setTimeout("location='<?php echo admin_url();?>masters/index'",1500);
							}else if(arr[0]==200){
