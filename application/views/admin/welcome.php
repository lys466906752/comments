...
<div class="page-container">
	<p class="f-20 text-success">欢迎使用军颐评论管理系统 <span class="f-14">v1.0</span>！</p>
	<p>本地登录IP：<?php echo ($this->adminInfos["login_ip"]);?> &nbsp;&nbsp;&nbsp;&nbsp; 本次登录时间： <?php echo date("Y-m-d H:i:s",$this->adminInfos['login_time']);?> </p>
  <p style="color:#999;">上次登录IP：<?php echo ($this->adminInfos["last_ip"]);?> &nbsp;&nbsp;&nbsp;&nbsp; 上次登录时间： <?php echo date("Y-m-d H:i:s",$this->adminInfos['last_time']);?></p>
