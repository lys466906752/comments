...
<div id="boxs" style="width:600px; height:230px; position:fixed;z-index:18; background:#FFF; border-radius:5px;box-shadow:-2px 0 2px #e4e4e4,2px 0 2px #e4e4e4,0 -2px 2px #e4e4e4,0 2px 2px #e4e4e4;">
    ...
    <div style="background:url(/public/images/sign-error-icon.png) 30px 40px no-repeat; width:118px; height:138px; float:left;"></div>
    ...
    <div style="width:97%; float:left; height:40px; padding-left:3%;font-size:14px; text-align:right; padding-top:10px;">
    	<a href="javascript:history.go(-1);" style="width:auto; display:inline-block; padding-left:15px; padding-right:15px; height:30px; line-height:30px; background:#cc0000;color:#fff; text-decoration:none; border-radius:2px;margin-right:20px;"> 返 回 上 页 </a> 
